...
4. **Robusto**: O conteúdo deve ser robusto o suficiente para ser interpretado por uma ampla gama de agentes de usuário, incluindo tecnologias assistivas.
...
- [ ] **Aria Labels**: Elementos complexos possuem os atributos ARIA corretos?

---

*Amago AI Kit: Inclusão através da excelência técnica.*
